...
class MultiwalletTest(unittest.TestCase):
    ...
    def test_sign_tx_from_psbt_without_xpubs(self):
        ...
        # HACK text as long as the previous line will send itself back to pexpect
        # this line may be required for very narrow terminals (github CI)
        self.expect("#tatkmj5q")
        self.expect(
